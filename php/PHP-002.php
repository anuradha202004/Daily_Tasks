...
--------------------------------------------
Task ID: PHP-002
Objective: Understanding Arrays & Debugging
Topics Covered:
1. Associative Array
2. Nested Arrays
...
// 1️ Create an associative array describing a person
$student = [
    "name" => "Rahul",
    "age" => 23,
    "skills" => ["PHP", "HTML", "CSS"]
...
$person = [ 
    "name" => "Anuradha" ,
    "age" => 21,
    "skills" => ["PHP", "JS" ,"React.js", "Node.js"]
];
